...
-- Game contents --
module GameContents(takeSecond, changeMoveState, flatten, removeItem, removeContent, checkRoom, roomItem, itemDesc, roomObject, objectDesc, eventDesc, getMovesText, getMoves, changeBool, newTextList, contentList, descriptionList, textList, eventDescriptionList, moveList)
where
...
eventDesc loc action = [last c | (a,b,c) <- eventDescriptionList, loc == a && action == (head c)]
...
contentList = [(1, 2, "Door", True), (1, 2, "Stone wall", True), (2, 1, "Torch", True), (3, 2, "Painting", True), (5, 1, "Yellow gem", True), (5, 2, "Chest", True), (7, 2, "Bridge", True), (7, 2, "Pedestal", True), (10, 1, "Shimmering coat", True), (10, 1, "White gem", True)]
...
eventDescriptionList = [(1, 2, ["Stone wall", "", "You push the stone and the door opens."]), (3, 2, ["Door", "Key", "You unlock the door."]), (3, 2, ["Painting", "", "There is a key behind the painting. You unlock the door with the key."])]--, (4, 1, ["Fireplace", "Torch", "A secret door opens as soon as you light up the fireplace"])]
