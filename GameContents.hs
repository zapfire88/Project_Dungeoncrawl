...
contentList = [(1, 2, "Door", True), (1, 2, "Stone wall", True), (2, 1, "Torch", True), (3, 2, "Painting", True), (4, 2, "Fireplace",True), (5, 1, "Yellow gem", True), (7, 2, "Bridge", True), (7, 2, "Pedestal", True), (9, 1, "Shimmering coat", True), (9, 1, "White gem", True), (10, 2, "Sphinx", True), (12, 1, "Scroll", True), (13, 2, "Bed", True), (13, 2, "Mirror", True)]

descriptionList = [(1, 2, ["Door", "An old wooden door without a handle."]), (1, 2, ["Stone wall", "There seem to be a 'loose' stone on the wall"]), (2, 1, ["Torch", "It gives of a weird light"]), (3, 2, ["Painting", "It is a gloomy painting of an eldery man."]), (3, 2, ["Door", "It is a wooden door with a keyhole"]), (5, 1, ["Yellow gem", "A small gem of yellow color in the shape of a hexagon."]), (7, 2, ["Bridge", "The bridge is raised. You need to lower it somehow."]), (7, 2, ["Pedestal", "There is a small socket in it. If the right thing is socketed in it, the bridge might be lowered."]), (9, 1, ["Shimmering coat", "It shimmers in changing colours. Maybe it has some magic properties?"]), (9, 1, ["White gem", "A beautiful white gem. It might be worth a fortune."]), (11, 1, ["Scroll", "It is a rolled up parchment. Something is written but you can't seem to understand it."]), (13, 2, ["Bed", "A skeleton is laying in the bed. It might be the old man from the painting"]), (13, 2, ["Mirror", "It seems the mirror does not reflect, but rather shows the entrence."])]

eventDescriptionList = [(1, 2, ["Stone wall", "", "You push the stone and the door opens."]), (3, 1, ["Door", "Key", "You unlock the door."]), (3, 2, ["Painting", "", "While looking closer at the painting you notice that one of the eyes on the man seems to be a button. When you press it the door opens."]), (4, 1, ["Fireplace", "Torch", "A secret door opens as soon as you light up the fireplace"]), (7, 1, ["Pedestal", "Yellow gem", "The bridge is lowered! Maybe the gem holds some sort energy?"]), (10, 2, ["Self", "Shimmering coat", "You test the coat against the shimmering wall. It passes through. You put it on and continue to the next room."])]

moveList = [(1,2,"Inside",False), (2,3,"Right",True), (2,7,"Forward",True), (3,2,"Back",True), (3,4,"Forward",False), (4,5,"Through hidden door",False), (4,6,"Forward",True), (5,4,"Back",True), (6,5,"Back",True), (6,5,"Back",True), (7,2,"Back",True), (7,8,"Over the bridge",False), (8,7,"Back",True), (8,9,"Right",True), (8,10,"Left",True), (9,8,"Back",True), (10,8,"Back",True), (11,10,"Back",True)]
